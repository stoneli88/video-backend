          ...
          <ButtonGroup>
            <Tooltip title="生成符合HLS格式的播放源。">
              <Button
                type="default"
                onClick={() =>
                  handleCreateJob.apply(this, [record, VideosComponent, "hls"])
                }
              >
                <Icon
            ...
            <Tooltip title="可以试看视频是否可以成功播放。">
              <Button
                type="default"
                onClick={() =>
                  handleCodeVideo.apply(this, [record, VideosComponent])
                }
              >
                <Icon
                  style={{ fontSize: "16px", verticalAlign: "-0.25em" }}
...
class Videos extends PureComponent {
  ...
  render() {
    ...
    return (
      <Layout
        className="App container-dashboard"
